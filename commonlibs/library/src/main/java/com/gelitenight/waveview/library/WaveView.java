...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#2899a4ff");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3C99a4ff");
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            switch (mShapeType) {
                case CIRCLE:
                    ...
                    float radius = getWidth() / 2f - borderWidth - 10f;
