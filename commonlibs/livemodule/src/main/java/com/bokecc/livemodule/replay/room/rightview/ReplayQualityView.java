...
public class ReplayQualityView extends BaseLinearLayout {
    ...
    private LiveQualityView.QualityCallBack qualityCallBack;
     ...
     */
    public void setQualityCallBack(LiveQualityView.QualityCallBack qualityCallBack) {
     ...
     * 设置数据，展示清晰度列表
     */
    public void setData(List<ReplayQualityinfo> videoQuality, ReplayQualityinfo currentQuality) {
        ...
        for (int i = 0; i < size; i++) {
            ReplayQualityinfo liveLineParams = videoQuality.get(i);
    ...
    private void handleItemClick(View v) {
        ...
        if (instance != null) {
            instance.changeQuality(qualityTextView.getQuality(), new ReplayChangeSourceListener() {
                @Override
