...
public class AppRTCBluetoothManager {
    ...
    public void updateDevice() {
        if (pairedDevices!=null&&bluetoothHeadset!=null){
            for (BluetoothDevice device : pairedDevices) {
                boolean audioConnected = bluetoothHeadset.isAudioConnected(device);
                Log.d(TAG, " name=" + device.getName() + ", address=" + device.getAddress()+"  audioConnected = "+audioConnected);
            }
        }
    ...
    protected void logBluetoothAdapterInfo(BluetoothAdapter localAdapter) {
        ...
        pairedDevices = localAdapter.getBondedDevices();
