...
import com.zxing.journeyapps.barcodescanner.camera.CameraInstance;
import com.zxing.journeyapps.barcodescanner.camera.CameraParametersCallback;
import com.zxing.journeyapps.barcodescanner.camera.CameraSettings;
import com.zxing.journeyapps.barcodescanner.camera.CameraSurface;
import com.zxing.journeyapps.barcodescanner.camera.CenterCropStrategy;
import com.zxing.journeyapps.barcodescanner.camera.DisplayConfiguration;
import com.zxing.journeyapps.barcodescanner.camera.FitCenterStrategy;
import com.zxing.journeyapps.barcodescanner.camera.FitXYStrategy;
import com.zxing.journeyapps.barcodescanner.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        if(framingRectSize != null) {
            ...
            intersection.offset(0,-verticalMargin+ (int) getContext().getResources().getDimension(R.dimen.scan_preview_margin_top) );
