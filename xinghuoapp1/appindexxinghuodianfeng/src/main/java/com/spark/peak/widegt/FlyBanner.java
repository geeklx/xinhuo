...
public class FlyBanner extends RelativeLayout {
    ...
    public void setPlaceHolderImage(int resources) {
        this.placeHolderResources = resources;
...
//            imageView.getHierarchy().setPlaceholderImage(R.mipmap.ic_launcher);
...
//            if (placeHolderResources != -1) {// TODO: 2017/8/22 设置占位图
//                GenericDraweeHierarchyBuilder builder =
//                        new GenericDraweeHierarchyBuilder(getResources());
//                GenericDraweeHierarchy hierarchy = builder
//                        .setPlaceholderImage(placeHolderResources)
...
//            }
            ...
            if (mIsImageUrl) {
                try {
                    Glide.with(getContext()).load(mImageUrls.get(toRealPosition(position))).placeholder(placeHolderResources == -1?-1:placeHolderResources).into(imageView);
