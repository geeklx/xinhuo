...
import kotlinx.android.synthetic.main.layout_lieve_cc_coupon_horizontal_dialog.*


import org.jetbrains.anko.*
import tuoyan.com.xinghuo_dayingindex.R
import tuoyan.com.xinghuo_dayingindex.R.layout.item_live_cc_coupon
 ...
 * 时间：  2017/5/13.
 */
class LiveCCCouponHorizontalDialog(context: Context, val click: (item: Coupon,dialog:LiveCCCouponHorizontalDialog) -> Unit) :
    Dialog(context, R.style.custom_dialog_full) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_lieve_cc_coupon_horizontal_dialog)
...
//        lp?.width = context.resources.displayMetrics.widthPixels / 10 * 9 //设置宽度
    ...
    class Adapter(context: Context, val itemClick: (item: Coupon) -> Unit) :
        ...
        override fun convertView(context: Context, parent: ViewGroup): View {
            return LayoutInflater.from(context).inflate(item_live_cc_coupon, parent,false)
        }
