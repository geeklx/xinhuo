 ...
 */
public class LiveGoodsVideoView extends RelativeLayout implements DWLiveVideoListener {
    private final String TAG = LiveGoodsVideoView.class.getSimpleName();

    private Context mContext;
    /**
     * 视频显示容器
     */
    private LiveGoodsTextureView mVideoContainer;
    /**
     * 视频加载进度
     */
    ...
    public LiveGoodsVideoView(Context context) {
        super(context);
        initViews(context);
    }

    public LiveGoodsVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(context);
    }

    public LiveGoodsVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void inflateViews() {
        View mRootView = LayoutInflater.from(mContext).inflate(R.layout.live_goods_video_view, null);
