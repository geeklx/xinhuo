...
public class FreeDragFloatView extends RelativeLayout {
    private int parentHeight;//悬浮的父布局高度
    private int parentWidth;
    private Context context;
    private String TAG="DragFloatView";

    public FreeDragFloatView(Context context) {
        this(context, null, 0);
        this.context = context;
    }

    public FreeDragFloatView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.context = context;
    }


    public FreeDragFloatView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = LayoutInflater.from(context).inflate(R.layout.free_float_view, this);
        renderView(view);
    }

    private void renderView(View view) {
        view.findViewById(R.id.rl).setOnTouchListener(new OnTouchListener() {
            @Override
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (getParent() != null) {
                    ...
                    parentHeight = parent.getHeight()- Utils.dip2px(context,40);
