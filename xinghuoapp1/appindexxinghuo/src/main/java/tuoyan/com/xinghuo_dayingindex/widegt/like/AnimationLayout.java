...
import tuoyan.com.xinghuo_dayingindex.widegt.like.evaluator.CurveEvaluatorRecord;
...
//        Log.d("zhao", "onMeasure: "+mViewWidth+"mViewHeight"+mViewHeight);
//        Log.d("zhao", "onMeasure:widthMeasureSpec "+widthMeasureSpec+"heightMeasureSpec"+heightMeasureSpec);
    }
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        this.mViewWidth = getMeasuredWidth();
        this.mViewHeight = getMeasuredHeight();
//        Log.d("zhao", "onSizeChanged: "+mViewWidth+"mViewHeight"+mViewHeight);
    }
