...
//            ResponseSlbBean2 responseSlbBean = gson.fromJson(rBody, ResponseSlbBean2.class);
    ...
    private void set_token_out() {
        MmkvUtils.getInstance().remove_common("userInfo");
        SPUtils.getInstance().put("token", "");
        ToastUtils.showLong("app长时间处于后台，登录信息失效。");
//        Activity topActivity = ActivityUtils.getTopActivity();
//        topActivity.runOnUiThread(new Runnable() {
//            @Override
//            public void run() {
//                if (topActivity instanceof SlbBaseActivity) {
//                    Intent intent = new Intent();
//                    intent.setAction("TAG_TOKEN_ACTION");
//                    intent.putExtra("query1", topActivity.getClass().getName());
//                    LocalBroadcastManagers.getInstance(topActivity).sendBroadcast(intent);
//                }
//            }
//        });
