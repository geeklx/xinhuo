...
public class RetrofitNetNew2 {
    private static RetrofitNetNew2 sInstance;
...
//        client.dispatcher().runningCalls().get(0).request().tag()
    ...
    private RetrofitNetNew2() {
        init();
    }

    public static void config() {
        sInstance = new RetrofitNetNew2();
    }

    public static RetrofitNetNew2 getInstance() {
        return sInstance;
    }
...
//                        .header("package_name", AppUtils.getAppPackageName() + "")
                        .header("package_name", "com.fosung.lighthouse.dtsxbb")
