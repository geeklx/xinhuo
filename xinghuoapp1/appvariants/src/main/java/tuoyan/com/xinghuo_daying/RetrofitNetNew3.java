...
public class RetrofitNetNew3 {
    private static RetrofitNetNew3 sInstance;
...
//        client.dispatcher().runningCalls().get(0).request().tag()
    ...
    private RetrofitNetNew3() {
        init();
    }

    public static void config() {
        sInstance = new RetrofitNetNew3();
    }

    public static RetrofitNetNew3 getInstance() {
        return sInstance;
    }
